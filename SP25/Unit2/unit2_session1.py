...
# 2. Write out in plain English what you want to do:
#    Loop through each element in the list, and keep track if the numbers are increasing or decreasing.

# 3. Translate each sub-problem into pseudocode:
#    By default, assume the list is both increasing AND decreasing
#    Loop through each index in the list, starting at index 1
#    Compare the current value to the previous value
#    If previous < current, decreasing must be False
#    If previous > current, increasing must be False
#    If either increasing or decreasing is still True, return True
