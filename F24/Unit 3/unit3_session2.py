...
#    Will we need a counter variable?

# 2. Write out in plain English what you want to do:
#    Convert string into integers and keep a total_sum variable to return at the end of the function.

# 3. Translate each sub-problem into pseudocode:
#    total_sum = 0
#    for i in s:
#      total_sum += integer version of num_str
#    return total_sum
